...
SECRET_KEY = 'django-insecure-6*!slzkz%24)@4&ecnr7o3t#r(_^)@#sgk@fz9-@il_08o_#47'
...
CORS_ALLOWED_ORIGINS = ["http://localhost:3000", "http://localhost:6308"]  # Allow Access
CORS_ALLOW_CREDENTIALS = True  # Access-Control-Allow-Credentials

CSRF_TRUSTED_ORIGINS = ["http://localhost:3000", "http://localhost:6308"]  # Needed to allow receiving POST request from the browser
