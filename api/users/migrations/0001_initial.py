    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_email', models.EmailField(default=None, max_length=254, null=True, unique=True)),
                ('secondary_email', models.EmailField(default=None, max_length=254, null=True, unique=True)),
