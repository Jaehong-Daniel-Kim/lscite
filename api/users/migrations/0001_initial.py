    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'A user with that email address already exists'}, help_text='Required. 254 characters or fewer in [email@domain.com] format', max_length=254, unique=True)),
